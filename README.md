...
*   **Question:** "We skip 4 frames, but stack 4 frames. Does skipping delete the frames we need?"
*   **Answer:** No. Skipping drops the *intermediate* frames to extend our memory horizon.
